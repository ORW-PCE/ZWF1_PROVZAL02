sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("zwf1.prozal02.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias zwf1.prozal02.controller.ListSelector
			 */
			...
			selectAListItem : function (sBindingPath) {
				...
				//this.oWhenListLoadingIsDone.then(
					//function () {
						...
						if (oSelectedItem && oSelectedItem.getBindingContext("Data").getPath() === sBindingPath) {
							return;
						}

						oList.getItems().some(function (oItem) {
							if (oItem.getBindingContext("Data") && oItem.getBindingContext("Data").getPath() === sBindingPath) {
			 ...
			 * @return {zwf1.prozal02.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
